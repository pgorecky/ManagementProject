...
class UpdateEmployeeComponent extends Component {
    ...
    editEmployee = (e) => {
        ...
        EmployeeService.editEmployee(employee, this.state.id).then(res =>{
                ...
                <div className='container' style={{marginTop: '50px', width: '70%'}}>
                    <div className='row'>
                        <div className='card col-md-6 offset-md-3 offset-md-3' style={{backgroundColor: '#c2c2c2'}}>
                            <h3 className='text-center' style={{color: '#2c2c2c', marginTop: '15px'}}><img src={person} alt="person" style={{width: "30px"}} />Edit Employee</h3>
                            <div className='card-body'>
                                <form>
                                    ...
                                    <button className='btn btn-success' style={{marginTop: '10px'}} onClick={this.editEmployee}>Update</button>
